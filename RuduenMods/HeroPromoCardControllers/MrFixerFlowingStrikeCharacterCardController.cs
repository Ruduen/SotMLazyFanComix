...
namespace RuduenWorkshop.MrFixer
{
    public class MrFixerFlowingStrikeCharacterCardController : PromoDefaultCharacterCardController
    {
        ...
        public override IEnumerator UsePower(int index = 0)
        {
            ...
            list.Add(new Function(this.DecisionMaker, "Draw 2 Cards", SelectionType.DrawCard, () => this.GameController.DrawCards(this.DecisionMaker, powerNumerals[3], cardSource: this.GetCardSource()), this.CanDrawCards(this.DecisionMaker), this.TurnTaker.Name + " cannot play any Style or Tool, so they must draw cards."));
