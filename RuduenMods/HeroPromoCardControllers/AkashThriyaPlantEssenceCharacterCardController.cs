...
namespace RuduenWorkshop.AkashThriya
{
    public class AkashThriyaPlantEssenceCharacterCardController : PromoDefaultCharacterCardController
    {
        ...
        public override IEnumerator UsePower(int index = 0)
        {
            ...
            SelectFunctionDecision sfd = new SelectFunctionDecision(this.GameController, this.DecisionMaker, list, false, null, this.TurnTaker.Name + " cannot draw or play any cards, so " + this.Card.Title + " has no effect.", null, this.GetCardSource());
