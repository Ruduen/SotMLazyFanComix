...
{
    public class VialOfMercuryCardController : SynthesistRelicSharedCardController
    {
        public VialOfMercuryCardController(Card card, TurnTakerController turnTakerController)
