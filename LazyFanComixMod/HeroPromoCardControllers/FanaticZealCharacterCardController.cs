...
namespace LazyFanComix.Fanatic
{
    public class FanaticZealCharacterCardController : PromoDefaultCharacterCardController
    {
        ...
        public override IEnumerator UsePower(int index = 0)
        {
            ...
            SelectFunctionDecision sfd = new SelectFunctionDecision(this.GameController, this.HeroTurnTakerController, list, false, null, this.TurnTaker.Name + " cannot discard or draw any cards or play any one-shots, so " + this.Card.Title + " has no effect.", null, this.GetCardSource());
