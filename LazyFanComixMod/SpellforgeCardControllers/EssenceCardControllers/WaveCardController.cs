...
namespace LazyFanComix.Spellforge
{
    public class WaveCardController : SpellforgeSharedEssenceCardController
    {
        ...
        protected override IEnumerator PerformModifiedAction(CardSource cardSource)
        {
            ...
            IEnumerator coroutine = this.GameController.SelectTargetsAndDealDamage(this.DecisionMaker, new DamageSource(this.GameController, this.CharacterCard), 2, DamageType.Lightning, 5, false, 5, cardSource: cardSource);
