...
namespace LazyFanComix.MrFixer
{
    public class MrFixerFocusedStrikeCharacterCardController : PromoDefaultCharacterCardController
    {
        ...
        public override IEnumerator UsePower(int index = 0)
        {
            ...
            list.Add(new Function(this.HeroTurnTakerController, "Play a Style or Tool", SelectionType.PlayCard, () => this.GameController.SelectAndPlayCardFromHand(this.HeroTurnTakerController, false, cardCriteria: new LinqCardCriteria((Card c) => c.IsOngoing || this.IsEquipment(c), "ongoing or equipment"),
