...
namespace LazyFanComix.BreachMage
{
  public abstract class BreachMageSharedSpellCardController : CardController
  {
    ...
    {
      IEnumerator coroutine = this.SelectCardThisCardWillMoveNextTo(new LinqCardCriteria((Card c) => c.Owner == this.HeroTurnTaker && this.GameController.DoesCardContainKeyword(c, "breach"), "breach"), storedResults, isPutIntoPlay, decisionSources);
