...
namespace LazyFanComix.Recall
{
  public class GoingThroughTheMotionsCardController : CardController
  {
    ...
    public override void AddTriggers()
    {
      ...
      this.AddTrigger<DealDamageAction>((DealDamageAction dda) => dda.DamageSource.IsCard && dda.DamageSource.Card == this.CharacterCard && dda.Target == this.CharacterCard, (DealDamageAction dda) => this.GameController.MakeDamageUnincreasable(dda, this.GetCardSource()), TriggerType.MakeDamageUnincreasable, TriggerTiming.Before);
    }
