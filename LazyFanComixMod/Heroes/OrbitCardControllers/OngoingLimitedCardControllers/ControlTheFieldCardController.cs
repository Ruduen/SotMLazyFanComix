    ...
    public class ControlTheFieldCardController : CardController
    {
        ...
        public override void AddTriggers()
        {
            this.AddStartOfTurnTrigger((TurnTaker tt) => tt == this.TurnTaker,
                (PhaseChangeAction pca) => this.GameController.SelectAndDestroyCards(this.DecisionMaker, new LinqCardCriteria((Card c) => c.IsCover, "cover"), 1, false, 1, cardSource: this.GetCardSource()), TriggerType.DestroyCard);
