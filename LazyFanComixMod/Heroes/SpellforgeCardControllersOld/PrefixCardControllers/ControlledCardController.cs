...
{
    // TODO: TEST!
    public class ControlledOldCardController : SpellforgeSharedModifierCardController
    {
        public ControlledOldCardController(Card card, TurnTakerController turnTakerController)
