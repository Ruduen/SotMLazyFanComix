...
{
    // TODO: TEST!
    public class PiercingOldCardController : SpellforgeSharedModifierCardController
    {
        public PiercingOldCardController(Card card, TurnTakerController turnTakerController)
