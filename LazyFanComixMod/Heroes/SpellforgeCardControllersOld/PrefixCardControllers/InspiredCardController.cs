...
{
    // TODO: TEST!
    public class InspiredOldCardController : SpellforgeSharedModifierCardController
    {
        public InspiredOldCardController(Card card, TurnTakerController turnTakerController)
