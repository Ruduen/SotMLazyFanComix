...
{
    // TODO: TEST!
    public class OfDisruptionOldCardController : SpellforgeSharedModifierCardController
    {
        public OfDisruptionOldCardController(Card card, TurnTakerController turnTakerController)
