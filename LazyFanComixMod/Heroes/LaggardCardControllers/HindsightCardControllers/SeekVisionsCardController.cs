...
namespace LazyFanComix.Laggard
{
  public class SeekVisionsCardController : LaggardSharedHindsightCardController
  {
    ...
    private IEnumerator MoveAndMayPlayCard()
    {
      ...
      coroutine = this.GameController.SelectAndMoveCard(this.HeroTurnTakerController, (Card c) => c.ParentDeck == owner.DeckDefinition, owner.Deck, cardSource: this.GetCardSource());
