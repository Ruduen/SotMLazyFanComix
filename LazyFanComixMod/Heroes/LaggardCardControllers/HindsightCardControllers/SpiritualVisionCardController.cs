...
namespace LazyFanComix.Laggard
{
  public class SpiritualVisionCardController : LaggardSharedHindsightCardController
  {
    ...
    private IEnumerator MoveAndMayPlayCard()
    {
      ...
      coroutine = this.GameController.SelectAndMoveCard(this.HeroTurnTakerController, (Card c) => c.Owner == owner && c.IsInTrash, owner.Deck, cardSource: this.GetCardSource());
