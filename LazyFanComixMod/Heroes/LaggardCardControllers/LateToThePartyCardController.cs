...
namespace LazyFanComix.Laggard
{
  public class LateToThePartyCardController : CardController
  {
    ...
    public override IEnumerator Play()
    {
      ...
      list.Add(new Function(this.HeroTurnTakerController, "Play up to 3 hindsight cards", SelectionType.PlayCard, () => this.GameController.SelectAndPlayCardsFromHand(this.HeroTurnTakerController, 3, false, 0, new LinqCardCriteria((Card c) => this.GameController.DoesCardContainKeyword(c, "hindsight"), "hindsight"), cardSource: this.GetCardSource()), this.CanPlayCardsFromHand(this.HeroTurnTakerController) && this.HeroTurnTaker.Hand.Cards.Any((Card c) => this.GameController.DoesCardContainKeyword(c, "hindsight"))));
