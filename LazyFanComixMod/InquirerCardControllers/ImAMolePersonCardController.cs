...
namespace LazyFanComix.Inquirer
{
    public class ImAMolePersonCardController : InquirerPersonaSharedCardController
    {
        ...
        public IEnumerator DealDamageResponse(PhaseChangeAction phaseChange)
        {
            ...
            // Deal Damage.
            coroutine = this.GameController.SelectTargetsAndDealDamage(this.HeroTurnTakerController, new DamageSource(this.GameController, this.CharacterCard), 1, DamageType.Melee, 1, false, 1, cardSource: this.GetCardSource());
